...
from Main.Main.fnd.SoundCode.SoundSys.Sound import *
...
class scan_scenarios(unittest.TestCase):
    ...
    def test_real_lib_1(self):
        obj1 = Sound([245, 188], 1, "Object 1. " + toilet_sign, True)
        obj3 = Sound([1179, 258], 1, "Object 2. " + long_text, True)
        obj2 = Sound([914, 274], 1, "Object 3. " + exit_sign, True)
        all_objects = [obj1, obj3, obj2]

        play_sounds(all_objects)

    def test_real_restaurant_2(self):
        obj2 = Sound([986, 253], 1, "Object 1. " + toilet_sign, True)
        obj3 = Sound([749, 230], 1, "Object 2. " + long_text, True)
        obj1 = Sound([249, 348], 1, "Object 3. " + "Il Calcio bistro", True)
    ...
    def test_long_text_3(self):
        ...
        obj1 = Sound([224, 371], 1, "Object 1. " + exit_sign, True)
        obj2 = Sound([1095, 224], 1,
        ...
        obj3 = Sound([1185, 556], 1, "Object 3. " + edhelp_sign, True)
    ...
    def test_real_cinema_4(self):
        obj1 = Sound([308, 253], 1, "Object 1. " + "Cinema City", True)
        all_objects = [obj1]
        play_sounds(all_objects)
    ...
    def test_real_lib_5(self):
        ...
        obj2 = Sound([1097, 60], 1, "Object 1. " + "Library Cafe", True)
        obj1 = Sound([583, 281], 1, "Object 2. " + edhelp_sign, True)
    ...
    def test_too_much_information(self):
        obj1 = Sound([79, 470], 1, "Object 1. " + "Il Calcio bistro", True)
        obj2 = Sound([65, 291], 1, "Object 2. " + edhelp_sign, True)
        obj3 = Sound([348, 195], 1, "Object 3. " + long_text, True)
        obj4 = Sound([700, 279], 1, "Object 3. " + exit_sign, True)
        obj5 = Sound([1076, 440], 1, "Object 3. " + toilet_sign, True)
        obj6 = Sound([937, 148], 1, "Object 3. " + long_text, True)
        all_objects = [obj1, obj2, obj3, obj4, obj5, obj6]

        play_sounds(all_objects)

    def test_all_left(self):
        obj1 = Sound([151, 113], 1, "Object 1. " + edhelp_sign, True)
        obj2 = Sound([186, 266], 1, "Object 2. " + "Library Cafe", True)
        obj3 = Sound([293, 503], 1, "Object 2. " + "Library Cafe", True)
        all_objects = [obj1, obj2, obj3]

        play_sounds(all_objects)

    def test_all_centre(self):
        obj1 = Sound([421, 419], 1, "Object 1. " + edhelp_sign, True)
        obj2 = Sound([623, 117], 1, "Object 2. " + "Library Cafe", True)
        obj3 = Sound([644, 392], 1, "Object 2. " + "Library Cafe", True)
        all_objects = [obj1, obj2, obj3]
    ...
    def test_choose_a_text_to_read(self):
        obj1 = Sound([249, 348], 1, "Object 1. " + long_text, True)
        obj2 = Sound([986, 253], 1, "Object 2. " + long_text, True)
        obj3 = Sound([749, 230], 1, "Object 3. " + long_text, True)
        text1 = "On successful completion of this course, you should be able to: " \
                "1. Working as members of a team in designing and implementing a complex and multi-faceted system" \
                "2. Planning and monitoring the effort of a project to meet milestones and deadlines, within a limited time scale" \
                "3. Drawing together knowledge and understanding of wide areas of software and hardware systems" \
